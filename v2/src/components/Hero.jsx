  ...
  return (
    ...
    >
      ...
      <div className="home-content">
        {/* The eyebrow read "Jensen & Juhl" above the headline, repeating the logotype
            already sitting top-left in the header. */}
        <div className="row home-content__main">
          ...
          <div className="svg-banner">
            <p className="svg-banner__word">Observe, refine, elevate.</p>
            <svg
              className="svg-banner__mark"
              ref={rotatingRef}
              viewBox="-112 -50 118 118"
